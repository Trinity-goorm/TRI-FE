    ...
    <style.TotalContainer>
      <style.TopBarContainer>
        <style.TopTitleBarContainer>
          <style.TopTitle>마이다이닝</style.TopTitle>
        </style.TopTitleBarContainer>
        <style.TopMoveBarContainer>
          <style.TopMoveEach
            isTopBarClick={isReservationClick}
            onClick={() => onClickTopBar("left")}
          >
            나의 예약
          </style.TopMoveEach>
          <style.TopMoveEach
            isTopBarClick={isVacancyClick}
            onClick={() => onClickTopBar("right")}
          >
            빈자리 알림
          </style.TopMoveEach>
        </style.TopMoveBarContainer>
      ...
      <style.InnerContainer>
        {isReservationClick ? <MyDiningReservation /> : <MyDiningVacancy />}
      </style.InnerContainer>
