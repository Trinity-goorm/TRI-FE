...
const MyDiningPage = lazy(() =>
  import('./pages/mydining/MyDiningPage.main.jsx')
);
const MyPage = lazy(() => import('./pages/mypage/MyPage.main.jsx'));
const ReservationMainPage = lazy(() =>
  import('./pages/reservation/Reservation.modal.jsx')
);
const ReservationConfirm = lazy(() =>
  import('./pages/reservation/Reservation.modal.confirm.jsx')
);
...
const SearchCategoryTotal = lazy(() =>
  import('./pages/search/SearchCategoryTotal.jsx')
);
const SearchKeywordTotal = lazy(() =>
  import('./pages/search/SearchKeywordTotal.jsx')
);
const ReservationPaymentPage = lazy(() =>
  import('./pages/reservation/Reservation.payment.jsx')
);
const MyDiningReservation = lazy(() =>
  import('./pages/mydining/MyDiningPage.reservation.jsx')
);
const MyDiningVacancy = lazy(() =>
  import('./pages/mydining/MyDiningPage.vacancy.jsx')
);
